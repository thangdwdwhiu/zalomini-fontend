...
export default memo(function Home() {
  ...
  const tabs = [
  { key: 'chat', element: (<ChatList />), name: 'nhắn tin', icon: (<i className="bi bi-messenger fs-3"></i>) },
    ...
    <>
      <div className="container-fluid d-flex">
        <div style={{ height: '100vh' }} className={styles.iconChat}>
          <img style={{ width: '50px', height: '50px', borderRadius: '50%' }} src={user.avatar} alt="avatar" />
          {tabs.map((item) => (
